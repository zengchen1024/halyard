...
public class HuaweiCloudCommandProperties {
  ...
  static final String USER_DATA_FILE_DESCRIPTION =
      "User data passed to Heat Orchestration Template. Replacement of tokens supported, see http://www.spinnaker.io/v1.0/docs/target-deployment-configuration#section-huaweicloud for details.";

  static final String HEAT_TEMPLATE_LOCATION_DESCRIPTION =
      "The location of your heat template file. (Replacing the Heat template is not recommended)";

  static final String LBAAS_POLL_TIMEOUT_DESCRIPTION =
      "Time to stop polling octavia when a status of an entity does not change. Default 60.";

  static final String LBAAS_POLL_INTERVAL_DESCRIPTION =
      "Interval in seconds to poll octavia when an entity is created, updated, or deleted. Default 5.";
